        ...
        <>
            <header role="banner">
                <div className="container">
                    <Link to="/" title="work" className="branding" aria-label="work" style={{ scrollMargin: '50px', scrollY: '-50 %' }}>


                        <img src={belllogo}  alt="logo" className="branding__logo" />
                        {/* 
                        <img src={belllogo}   /> */}

                        {/* 
                        <svg version="1.1" id="Layer_1"
                            x="0px" y="0px" viewBox="0 0 612 284.73"
                            style="enable-background:new 0 0 612 284.73;" />
 */}
                    ...
                    <input type="checkbox" id="menu-toggle" className="checkbox-toggle js-checkbox-toggle"
                        data-html-toggle="menu-active" />
                    <label className="site-nav__btn burger">
                        <span className="burger__inner"><i className="sr-only">Menu Toggle</i></span>
                    </label>
                    <nav role="navigation" className="site-nav js-site-nav">
                        <ul className="site-nav__list">
                            <li className="site-nav__item--work site-nav__item">
                                <Link to="/" data-drupal-link-system-path="work">work</Link>
                            </li>
                            <li className="site-nav__item">
                                <Link to="/about" >About</Link>
                            </li>
                            <li className="site-nav__item--work site-nav__item">
                                <Link to="/" data-drupal-link-system-path="careers">Careers</Link>
                            </li>
                            <li className="site-nav__item">
                                <Link to="/" data-drupal-link-system-path="contact">Contact</Link>
                            </li>
                        </ul>
                    </nav>
                </div>
